...
class DedicatedHostsImpl {
    ...
    listByHostGroupPagingPage(resourceGroupName, hostGroupName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listByHostGroupPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listByHostGroup(resourceGroupName, hostGroupName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listByHostGroupNext(resourceGroupName, hostGroupName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listByHostGroupPagingAll(resourceGroupName, hostGroupName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listByHostGroupPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listByHostGroupPagingPage(resourceGroupName, hostGroupName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    listAvailableSizesPagingPage(resourceGroupName, hostGroupName, hostName, options, _settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listAvailableSizesPagingPage_1() {
            let result;
            result = yield tslib_1.__await(this._listAvailableSizes(resourceGroupName, hostGroupName, hostName, options));
            yield yield tslib_1.__await(result.value || []);
        });
    }
    listAvailableSizesPagingAll(resourceGroupName, hostGroupName, hostName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, hostGroupName, hostName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
