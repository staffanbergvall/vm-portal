...
class CommunityGalleryImageVersionsImpl {
    ...
    listPagingPage(location, publicGalleryName, galleryImageName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield tslib_1.__await(this._list(location, publicGalleryName, galleryImageName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listNext(location, publicGalleryName, galleryImageName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPagingAll(location, publicGalleryName, galleryImageName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPagingPage(location, publicGalleryName, galleryImageName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
