...
class AvailabilitySetsImpl {
    ...
    listAvailableSizesPagingPage(resourceGroupName, availabilitySetName, options, _settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listAvailableSizesPagingPage_1() {
            let result;
            result = yield tslib_1.__await(this._listAvailableSizes(resourceGroupName, availabilitySetName, options));
    ...
    listAvailableSizesPagingAll(resourceGroupName, availabilitySetName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, availabilitySetName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues(page)));
