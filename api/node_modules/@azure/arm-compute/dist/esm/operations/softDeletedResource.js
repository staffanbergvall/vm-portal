...
export class SoftDeletedResourceImpl {
    ...
    listByArtifactNamePagingPage(resourceGroupName, galleryName, artifactType, artifactName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByArtifactNamePagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByArtifactName(resourceGroupName, galleryName, artifactType, artifactName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByArtifactNameNext(resourceGroupName, galleryName, artifactType, artifactName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByArtifactNamePagingAll(resourceGroupName, galleryName, artifactType, artifactName, options) {
        return __asyncGenerator(this, arguments, function* listByArtifactNamePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByArtifactNamePagingPage(resourceGroupName, galleryName, artifactType, artifactName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
