...
export class VirtualMachineImagesImpl {
    ...
    listWithProperties(location, publisherName, offer, skus, expand, options) {
        const iter = this.listWithPropertiesPagingAll(location, publisherName, offer, skus, expand, options);
        return {
            next() {
                return iter.next();
            },
            ...
            byPage: (settings) => {
                ...
                return this.listWithPropertiesPagingPage(location, publisherName, offer, skus, expand, options, settings);
            },
        };
    }
    listWithPropertiesPagingPage(location, publisherName, offer, skus, expand, options, settings) {
        return __asyncGenerator(this, arguments, function* listWithPropertiesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listWithProperties(location, publisherName, offer, skus, expand, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listWithPropertiesNext(location, publisherName, offer, skus, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listWithPropertiesPagingAll(location, publisherName, offer, skus, expand, options) {
        return __asyncGenerator(this, arguments, function* listWithPropertiesPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listWithPropertiesPagingPage(location, publisherName, offer, skus, expand, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    _listWithProperties(location, publisherName, offer, skus, expand, options) {
     ...
     * @param options The options parameters.
     */
    _listWithPropertiesNext(location, publisherName, offer, skus, nextLink, options) {
        return this.client.sendOperationRequest({ location, publisherName, offer, skus, nextLink, options }, listWithPropertiesNextOperationSpec);
    }
}
...
const listWithPropertiesNextOperationSpec = {
    path: "{nextLink}",
    httpMethod: "GET",
    responses: {
        200: {
