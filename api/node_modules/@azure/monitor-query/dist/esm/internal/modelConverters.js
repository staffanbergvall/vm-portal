...
import { convertIntervalToTimeIntervalObject, convertTimespanToInterval, } from "../timespanConversion.js";
import { LogsQueryResultStatus } from "../models/publicLogsModels.js";
/**
 * @internal
 */
export function convertRequestForQueryBatch(batch) {
    let id = 0;
 ...
 * @internal
 */
export function convertResponseForQueryBatch(generatedResponse, rawResponse) {
 ...
 * @internal
 */
export function fixInvalidBatchQueryResponse(generatedResponse, rawResponse) {
 ...
 * @internal
 */
export function convertRequestForMetricsBatchQuery(metricsQueryResourcesOptions) {
 ...
 * @internal
 */
export function convertRequestForMetrics(metricNames, queryMetricsOptions) {
 ...
 * @internal
 */
export function convertResponseForMetrics(generatedResponse) {
 ...
 * @internal
 */
export function convertRequestOptionsForMetricsDefinitions(options) {
    if (!options) {
        return {};
    }
...
export function convertResponseForMetricBatch(generatedResponse) {
    const result = [];
 ...
 * @internal
 */
export function convertResponseForMetricsDefinitions(generatedResponse) {
 ...
 * @internal
 */
export function convertResponseForMetricNamespaces(generatedResponse) {
 ...
 * @internal
 */
export function convertGeneratedTable(table) {
 ...
 * @internal
 */
export function convertBatchQueryResponseHelper(response) {
    try {
...
export function computeResultType(generatedResponse) {
