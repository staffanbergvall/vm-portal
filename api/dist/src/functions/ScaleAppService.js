...
exports.ScaleAppService = ScaleAppService;
/**
...
function extractPlanName(serverFarmId) {
...
async function ScaleAppService(request, context) {
...
functions_1.app.http('ScaleAppService', {
    methods: ['PATCH'],
    authLevel: 'anonymous',
    route: 'appservices/{appServiceName}/scale',
    handler: ScaleAppService
});
//# sourceMappingURL=ScaleAppService.js.map