...
async function ListSchedules(request, context) {
    ...
    try {
        ...
        const schedulesResult = await client.schedule.listByAutomationAccount(AUTOMATION_RESOURCE_GROUP, azureAuth_1.AUTOMATION_ACCOUNT_NAME);
        ...
        return {
            ...
            jsonBody: {
                ...
                automationAccount: azureAuth_1.AUTOMATION_ACCOUNT_NAME
            }
        };
    }
    catch (error) {
